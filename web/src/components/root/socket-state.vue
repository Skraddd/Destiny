    ...
    <div class="socket-state">
        ...
        <template v-if="!socket">
            ...
            <p>Enter your computer code to start controlling League from your phone. You can find the code by
                right-clicking on the Destiny icon in the bottom right of your computer.</p>
        ...
        <template v-else-if="isConnecting">
            ...
            <p style="margin-bottom: 40px">Trying to connect to Destiny HQ... If this takes longer than a few seconds,
        ...
        <template v-else-if="isHandshaking">
            ...
            <p style="margin-bottom: 40px">Destiny is waiting for your desktop to approve the connection. Simply click the
