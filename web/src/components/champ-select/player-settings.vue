<template>
    <div class="player-settings">
        <div class="chevron" v-if="!allowsReroll">
            <div class="expand-button" @click="$emit('expand')">
                <i class="ion-chevron-up"></i>
            </div>

            <div class="reroll-button bordered" v-if="$parent.isArena" @click="toggleBravery()">
                <i class="ion-shuffle" style="margin-right: 15px"></i>
                <span>Bravery</span>
            </div>
        </div>
