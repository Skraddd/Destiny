...
namespace Conduit
{
    class Program
    {
        ...
        // same computer. Can still be overridden with the MIMIC_HUB environment
        ...
        /**
         * Reads an alternative hub (Rift) location from the MIMIC_HUB environment
         ...
         * or  set MIMIC_HUB=http://192.168.1.10:51001
         */
        private static void LoadHubOverride(string[] args)
        {
            var hub = Environment.GetEnvironmentVariable("MIMIC_HUB");
        ...
        public static void Main(string[] args)
        {
            ...
            _singleInstanceMutex = new System.Threading.Mutex(true, "MimicConduitLocalSingleInstance", out isFirstInstance);
            if (!isFirstInstance)
            {
